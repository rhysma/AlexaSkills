...
namespace womenintechfact
{
    class FactData
    {
        ...
        public static List<FactData> LoadFacts()
        {
            ...
            facts.Facts.Add("The first computer programmer was Ad Lovelace");
            ...
            facts.Facts.Add("Carol Shaw was a pioneer game developer for Atari in 1978 and was noted as one of the best programmers for the 6502 microprocessor");
